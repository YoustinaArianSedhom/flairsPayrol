...
export class TablesService {
  ...
  /**
   * Update column configuration for the all rows
   * @param {columnId} 
   */
  public updateColumnConfig(columnId: string, updates) {
    let column = this.config.columns.find(column => column.key == columnId)
