...
export class PaginationComponent implements OnInit {
  ...
  private _defaults: PaginationConfigModel = {
    ...
    pageSizeOptions: OrgConfigInst.CRUD_CONFIG.paginationDefaults.options,
    activePageSize: OrgConfigInst.CRUD_CONFIG.paginationDefaults.size,
  }
  ...
  private _setPageSizeOptions() {
    ...
    if (recordsTotalCount > 10) {
      ...
      const defaultOptions = OrgConfigInst.CRUD_CONFIG.paginationDefaults.options;
